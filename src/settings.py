...
ORIGINABOT_PASS = os.getenv("ORIGINABOT_PASS")
ORIGINABOT_USER = os.getenv("ORIGINABOT_USER")
ORIGINABOT_HOST = os.getenv("ORIGINABOT_HOST")
ORIGINABOT_PORT = os.getenv("ORIGINABOT_PORT")
ORIGINABOT_NAME = os.getenv("ORIGINABOT_NAME")
