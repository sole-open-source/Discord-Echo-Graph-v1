...
logger = get_logger(module_name="DBchat", DIR="queryAgent")
...
if __name__=="__main__":
    ...
    system_prompt = DB_AGENT_SYSTEM_PROMPT_1.format(top_n=15, description=1)
...
"""
python3 -m src.services.v1.ChatEdubot.DBagent
