...
from .toolkit import LightRagToolKit
...
def create_chat_agent(llm : BaseChatModel) -> CompiledStateGraph:
...
if __name__=="__main__":
    ...
    messages = [SystemMessage(content=SYSTEM_PROMPT_2)]
    while True:
        print("========================= Human Message =============================\n")
        human_message = input()
...
"""
python3 -m src.services.v2.ChatLightRag.agent
